        ...
        <div class="row">
            <div class="col-md-4 mx-auto p-4 my-4 card js-tilt">
                ...
                <form action="{{route('vendor.create')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Shopname</label>
                        <input type="text" name="shopname" value="{{old('shopname')}}" class="form-control" placeholder="Enter shopname">
                        @error('shopname')
                    ...
                    <div class="mb-3 form-check">
                        ...
                        <label class="form-check-label" for="exampleCheck1"><a href="#">I agree with the terms and conditons.</a></label>
                    </div>
                ...
                <div class="mt-2">
                    <a href="{{route('vendor.login')}}" class='btn btn-outline-danger text-center'>Login</a>
                </div>
